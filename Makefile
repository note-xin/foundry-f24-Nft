...
.PHONY: cat all test test-all clean fund help install snapshot format anvil deploy-nft deploy-dnft mint mint-dnft other-cat
...
help:
	...
	@echo ""
	@echo "usage :"
	@echo " make deploy-nft [ARGS]\n 		example: make deploy-nft ARGS=\"--network sepolia\""
	@echo " make deploy-dnft [ARGS]\n 		example: make deploy-dnft ARGS=\"--network sepolia\""
	@echo " make cat"
...
deploy-nft:
	@forge script script/Deploy__Nft.s.sol:Deploy $(NETWORK_ARGS)

deploy-dnft:
	@forge script script/Deploy__DNft.s.sol:Deploy $(NETWORK_ARGS)

mint:
	@forge script script/Interaction.s.sol:MintNft $(NETWORK_ARGS)

mint-dnft:
	@forge script script/Interaction.s.sol:MintDNft $(NETWORK_ARGS)	

other-cat:
	@forge script script/Interaction.s.sol:OtherCat $(NETWORK_ARGS)